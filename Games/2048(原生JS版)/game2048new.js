// (function game2048(rows, cols) {
	...
	function generateSquare(value, row, col) {
		...
		square.style.backgroundColor = colorMap[value];
	...
	function generateRandomNum() {
		...
		for (;;) {
			...
			if (valueSet[randRowIdx][randColIdx] == 0) {
				boardSet[randRowIdx][randColIdx].value = rand;
				boardSet[randRowIdx][randColIdx].style.backgroundColor = colorMap[rand];
				boardSet[randRowIdx][randColIdx].innerHTML = "" + rand;
				// var obsoletedSquare =  document.getElementById(randRowIdx + "-" + randColIdx);
				// var square = generateSquare(rand, randRowIdx, randColIdx);
				squareSet[randRowIdx][randColIdx] = boardSet[randRowIdx][randColIdx];
